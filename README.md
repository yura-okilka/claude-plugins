...
| ------ | ----------- | ------- |
| [`toast-notify`](./plugins/toast-notify) | Windows desktop notifications for Claude Code, with click-to-focus for the originating terminal. **Windows 10/11.** | `/plugin install toast-notify@yura-okilka` |
